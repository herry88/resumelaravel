...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
      <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
          <div class="container">
              <a class="navbar-brand js-scroll-trigger" href="#page-top">Resume Saya</a>
      ...
      <header class="masthead bg-primary text-white text-center">
          <div class="container d-flex align-items-center flex-column">
              ...
              <h1 class="masthead-heading text-uppercase mb-0">
                {{ isset($about[0]->nama) ? $about[0]->nama : '' }}
              </h1>
              <!-- Icon Divider-->
      ...
      <!-- Contact form JS-->
      <script src="{{asset('assets/img/mail/jqBootstrapValidation.js')}}"></script>
      <script src="{{asset('assets/img/mail/contact_me.js')}}"></script>
      <!-- Core theme JS-->
